...
The [app](https://austinkuruvilla-nlp-text-classification-app-1zee8h.streamlit.app/) loads the serialized model artifacts and returns a ham or spam prediction for a message entered in the text area.
